...
<option value="JEE">JEE</option>
	...
	<input type="submit" name="filter_value" class="btn btn-primary" value="filter" style="margin-left: 1032px;margin-top: -60px;padding: 9px;width: 70px;height: 40px;">
...
<input type="submit" value="SAVE RESULTS" name="submit" class="btn btn-success">
</form>
</div>
