...
<ul>
	<li><a href="student_attendance.php"><i class="fas fa-clipboard"></i> STUDENT ATTENDANCE</a></li>
	<li><a href="markuptation.php"><i class="fab fa-wpforms"></i>MARKUPTATION</a></li>
    <li><a href="staff_fee.php"><i class="fas fa-book"></i> VIEW FEE DETAILS</a></li>
    <li><a href="#"><i class="far fa-edit"></i>EXAMINATION</a></li>
    <li><a href="announcement.php"><i class="fas fa-bullhorn"></i>ANNOUNCEMENT</a></li>
    <li><a href="liveclass.php"><i class="fas fa-satellite-dish"></i>LIVECLASSES</a></li>
